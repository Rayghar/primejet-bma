...
import { 
    ...
    ClipboardList, DollarSign, Briefcase, UserCheck, RotateCcw, Calculator, History, Bell, Link, SlidersHorizontal, FileArchive, ClipboardCheck, ShieldCheck
} from 'lucide-react';
...
{ id: 'ProductPriceBranchConfig', label: 'Product & Pricing', icon: Settings },
            { id: 'PlantReliabilityCommandCenter', label: 'Plant Reliability', icon: Activity },
            { id: 'PlantCommandCenter', label: 'Plant Command', icon: Activity },
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'CustomerHub', label: 'Customer List', icon: Users },
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'Configuration', label: 'System Config', icon: Settings, help: 'Global business configuration including operational defaults and WhatsApp settings.' },
