...
export default function FinanceControlReports() {
  ...
  const loadBranchOptions = async () => {
    try {
      ...
      console.error('Failed to load finance branch options:', e);
      setBranchOptions([]);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/60 border border-white/10 rounded-2xl p-4 space-y-3">
        ...
        <p className="text-xs text-slate-500">Use this filter across cash movement, expense analysis, branch P&L, wallet liability, failed payments, reversal approvals and posting batches.</p>
      </div>
