...
export const MODULE_CATALOG = {
  ...
  CorporateClientsModule: { permission: PERMISSIONS.SALES_CORPORATE_VIEW },
  CorporateAccounts: { permission: PERMISSIONS.SALES_CORPORATE_VIEW },
  CorporateOnboarding: { permission: PERMISSIONS.SALES_CORPORATE_VIEW },
  CorporatePortalAccess: { permission: PERMISSIONS.SALES_CORPORATE_MANAGE },
  CorporateSites: { permission: PERMISSIONS.SALES_CORPORATE_MANAGE },
  CorporateRequests: { permission: PERMISSIONS.SALES_CORPORATE_VIEW },
  CorporateFulfilmentControl: { permission: PERMISSIONS.SALES_CORPORATE_MANAGE },
  CorporateBilling: { permission: PERMISSIONS.SALES_CORPORATE_VIEW },
  CorporateRelationshipDesk: { permission: PERMISSIONS.SALES_CORPORATE_VIEW },
